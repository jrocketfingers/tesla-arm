...
1.
Add roles-Print and Document Services-next-next-
...
2.
Udjite u print menagement-ports desni klik add port-standard tcp/ip-new port-next-printer name:adresa(192.168.1.101)
